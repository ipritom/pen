...
![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/dt5dfld94zyuaylale5v)
...
![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/vkew9nsvmwrpydeg40vl)
*<small>RM : 7.3.8 APB1 peripheral clock enable register </small>*

একটা উদাহরণ হিসেবে রেফারেন্স ম্যানুয়ালের একটি পেজ দেখানো হলো। এখানে আমরা `RCC` এর আন্ডারে `APB1ENR` রেজিস্টারের ৩২ টা বিটের সংক্ষিপ্ত বর্ণনা দেখতে পাচ্ছি। RCC এর আন্ডারে এরকম আরও অনেক রেজিস্টার আছে যা এক নজরে প্রতি অধ্যায়ের শেষে দেয়া `registers map` সেকশন থেকে দেখে নিতে পারেন।
...
![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/trhyhbeanjq2huza5tud)
...
![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/mhhmvzwnagnhsbcu1i44)
...
ডাটাশিট থেকে আমরা জানি, GPIO পোর্টগুলা APB2 এ কানেক্টেড। এই বাস লাইনে ক্লক এনাবল করার জন্য আমরা রেজিস্টার ডেসক্রিপশন দেখব। 

![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/j78xnvmf4vnvknrwcdxg)
...
এখান থেকে আমাদের রেজিস্টারের বিট ম্যানিপুলেশন শুরু। এই ক্ষেত্রে আমরা বিটওয়াইজ অপারেশন কাজে লাগাবো, যাতে অন্য কোনো বিট পরিবর্তন না করে আমরা সহজেই একটা বিট সেট (1) বা রিসেট (0) করতে পারি। যদি আমরা বিটওয়াইজ অপারেশন না করি তাহলে আমাদের ৩২ বিটের নাম্বার সেট করতে হবে সরাসরি ওই রেজিস্টারে। একইসাথে অন্যান্য বিটের ডিফল্ট ভ্যালুও মেইন্টেইন করতে হবে।  

একটা নির্দিষ্ট বিট সেট করার জন্য bitwise OR assignment operation করতে হবে। 
...
![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/hzinyxw5imts3he1vthk)
*<small>RM : 9.2.2 Port configuration register high (GPIOx_CRH)</small>*

এখানে কিছু গুরুত্বপূর্ণ ব্যাপার খেয়াল করার আছে। এখানে রিসেট ভ্যালু hex নাম্বার ফরমেটে হিসেবে দেয়া আছে। এখান থেকে আমরা বুঝতে পারছি এখানে সব বিটের মান কিন্তু by default জিরো থাকবে না। তাই যদি কনফিগারেশনের জন্য কোনো বিটের ভ্যালু আলদা করে রিসেট (0) করতে হবে। 

ডাটাশিট থেকে আমরা দেখতে পারছি এই রেজিস্টারে `CNFy` এবং `MODEy` এই দুই রকমের বিটে ভাগ করা। এখানে `y` এর ভ্যালু হচ্ছে পিন নাম্বার। আমরা যেহেতু ১৩ নাম্বার পিন নিয়ে কাজ করছি তাই এখানে `y=13`। 

অর্থাৎ এই রেজিস্টারে ২০-২৩ নাম্বার বিট আমাদের ম্যানিপুলেট করতে হবে। 

প্রথমত আউটপুট মোডের জনয় `CNFy` এর দুইটা বিটের ভ্যাল্য `00` হবে যা ২৩ ও ২২ নাম্বার পজিশনে আছে। 
...
এরপর আমরা আউটপুট মোডের জনয় ক্লকের স্পিড সিলেক্ট করতে পারবো। এখানে আমাদের 10 MHz, 2 MHz এবং 50 MHz অপশন আছে। আমরা এখানে 10 MHz সিলেক্ট করছি।
...
আমাদের GPIO পোর্ট এবং পিন কনফিগারেশন করা শেষ। এবার সময় আউটপুটে লজিক সেট করার। এই সম্পর্কিত তথ্য আমরা পাবো Port output data register সেকশনে।


![](https://res.cloudinary.com/djqcqqueb/image/upload/f_auto,q_auto/v1/stm32_chap0/ijddu6btifsobz2pvc4f)
*<small>RM : 9.2.4 Port output data register (GPIOx_ODR)</small>*

এখান থেকে আমরা বুঝতে পারছি যে `ODR13` বিট আমাদের সেট বা রিসেট করতে হবে Blue Pill এর user LED অন-অফ করার জন্য। 

Blue Pill এর হার্ডওয়ার ডিজাইনে PC13 পিনটা একটিভ লো (active low)। অর্থাৎ, লজিক Low হলে LED ON হবে। তার মানে রেজিস্টারের এই বিটটার ভ্যালু রিসেট বা 0 থাকলেই LED জলবে। আমরা একটা ইনফাইনাইট লুপের মধ্যে এই ভ্যালুটা রিসেট রাখতে পারি। 
